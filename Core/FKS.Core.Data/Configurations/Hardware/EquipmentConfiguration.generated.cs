...
//     重新生成代码，这些更改将会丢失。
//		如存在本生成代码外的新需求，请在相同命名空间下创建同名分部类实现 EquipmentConfigurationAppend 分部方法。
// </auto-generated>
...
namespace FKS.Core.Data.Configurations.Hardware
{
    ...
    /// 实体类-数据表映射——用户信息
    /// </summary>    
	internal partial class EquipmentConfiguration : EntityTypeConfiguration<Equipment>, IEntityMapper
    {
        /// <summary>
        /// 实体类-数据表映射构造函数——用户信息
        /// </summary>
        ...
        /// 额外的数据映射
        /// </summary>
        partial void EquipmentConfigurationAppend();
