            ...
            e.$menus ? e.$menus.tree({
                ...
                onLoadSuccess: function () {
                    if (a(".hidden")[0].children.IsAdmin.value == "False") {
                        if (a(".hidden")[0].children.NickName.value != "松江教育局") {
                            ...
                            this.childNodes[0].children[1].children[0].hidden = !0;
                            this.childNodes[0].children[1].children[1].hidden = !0;
                            this.childNodes[0].children[1].children[3].hidden = !0;
                            this.childNodes[3].hidden = !0;
                        }
                    }
