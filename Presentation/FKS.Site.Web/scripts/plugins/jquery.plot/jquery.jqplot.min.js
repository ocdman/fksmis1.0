...
function (a) {
    ...
    function g() {
        ...
        function j(b, c) {
            ...
            for (g = c.seriesStack.length - 1; g >= 0; g--) switch (e = c.seriesStack[g], h = x[e], u = h._highlightThreshold, h.renderer.constructor) {
                case a.jqplot.BarRenderer:
                    for (j = b.x, k = b.y, f = 0; f < h._barPoints.length; f++) if (t = h._barPoints[f], s = h.gridData[f], j > t[0][0] && j < t[2][0] && k > t[2][1] && k < t[0][1]) return {
                        seriesIndex: h.index,
                        pointIndex: f,
                        gridData: s,
                        data: h.data[f],
                ...
                case a.jqplot.BubbleRenderer:
                    ...
                    var y = null;
                    if (h.show) {
                        for (var f = 0; f < h.gridData.length; f++) s = h.gridData[f],
                        r = Math.sqrt((j - s[0]) * (j - s[0]) + (k - s[1]) * (k - s[1])),
                        r <= s[2] && (q >= r || null == q) && (q = r, y = {
                            seriesIndex: e,
                            pointIndex: f,
                            gridData: s,
                            data: h.data[f]
                ...
                case a.jqplot.LineRenderer:
                    if (j = b.x, k = b.y, i = h.renderer, h.show) {
                        if (!(!(h.fill || h.renderer.bands.show && h.renderer.bands.fill) || c.plugins.highlighter && c.plugins.highlighter.show)) {
                            var F = !1;
                            if (j > h._boundingBox[0][0] && j < h._boundingBox[1][0] && k > h._boundingBox[1][1] && k < h._boundingBox[0][1]) for (var G, H = h._areaPoints.length,
                            f = H - 1,
                            G = 0; H > G; G++) {
                                var I = [h._areaPoints[G][0], h._areaPoints[G][1]],
                                J = [h._areaPoints[f][0], h._areaPoints[f][1]]; (I[1] < k && J[1] >= k || J[1] < k && I[1] >= k) && I[0] + (k - I[1]) / (J[1] - I[1]) * (J[0] - I[0]) < j && (F = !F),
                                f = G
                            }
                            if (F) return {
                                seriesIndex: e,
        ...
        this.init = function (c, d, e) {
            ...
            for (var f = 0,
            j = G.length; j > f; f++) this.axes[G[f]] = new b(G[f]);
            ...
            for (var n, o, f = 0,
            j = G.length; j > f; f++) n = G[f],
            o = this.axes[n],
            o._plotDimensions = this._plotDimensions,
            o.init(),
            null == this.axes[n].borderColor && (o.borderColor = "x" !== n.charAt(0) && o.useSeriesColor === !0 && o.show ? o._series[0].color : this.grid.borderColor);
        ...
        this.resetAxesScale = function (b, c) {
            var d = c || {},
            e = b || this.axes;
            if (e === !0 && (e = this.axes), a.isArray(e)) for (var f = 0; f < e.length; f++) this.axes[e[f]].resetScale(d[e[f]]);
            else if ("object" == typeof e) for (var g in e) this.axes[g].resetScale(d[g])
        },
        this.reInitialize = function (c, d) {
            for (var e = a.extend(!0, {},
            this.options, d), f = this.targetId.substr(1), g = null == c ? this.data : c, i = 0; i < a.jqplot.preInitHooks.length; i++) a.jqplot.preInitHooks[i].call(this, f, g, e);
            ...
            c && (e.dataRenderer && a.isFunction(e.dataRenderer) && (e.dataRendererOptions && (this.dataRendererOptions = e.dataRendererOptions), this.dataRenderer = e.dataRenderer, c = this.dataRenderer(c, this, this.dataRendererOptions)), this.data = a.extend(!0, [], c)),
            ...
            for (var i = 0,
            n = G.length; n > i; i++) j = G[i],
            m = this.axes[j],
            m._plotDimensions = this._plotDimensions,
            m.init(),
            null == m.borderColor && (m.borderColor = "x" !== j.charAt(0) && m.useSeriesColor === !0 && m.show ? m._series[0].color : this.grid.borderColor);
            this.sortData && h(this.series),
            this.grid.init(),
            this.grid._axes = this.axes,
            this.legend._series = this.series;
            for (var i = 0,
            n = a.jqplot.postInitHooks.length; n > i; i++) a.jqplot.postInitHooks[i].call(this, f, this.data, e);
            for (var i = 0,
            n = this.postInitHooks.hooks.length; n > i; i++) this.postInitHooks.hooks[i].call(this, f, this.data, e)
        },
        this.quickInit = function () {
            ...
            this.eventCanvas._plotDimensions = this._plotDimensions,
            this.legend._plotDimensions = this._plotDimensions;
            for (var b in this.axes) this.axes[b]._plotWidth = this._width,
            ...
            this._sumx = 0,
            this.computePlotData();
            for (var c = 0; c < this.series.length; c++) "line" === this.series[c]._type && this.series[c].renderer.bands.show && this.series[c].renderer.initBands.call(this.series[c], this.series[c].renderer.options, this),
        ...
        this.computePlotData = function () {
            ...
            for (c = 0, d = this.series.length; d > c; c++) {
                ...
                if (this.stackSeries && !b.disableStack) {
                    ...
                    for (var m = 0; m < b.data.length; m++) f.x.push(b.data[m][0]),
                    f.y.push(b.data[m][1]);
                ...
                for (c > 0 && (b._prevPlotData = this.series[c - 1]._plotData), b._sumy = 0, b._sumx = 0, m = b.data.length - 1; m > -1; m--) b._sumy += b.data[m][1],
                b._sumx += b.data[m][0]
            }
        },
        this.populatePlotData = function (b, c) {
            ...
            if (this.stackSeries && !b.disableStack) {
                b._stack = !0;
                for (var e, f, g, h, i = "x" === b._stackAxis ? 0 : 1, j = a.extend(!0, [], b.data), k = a.extend(!0, [], b.data), l = 0; c > l; l++) for (var m = this.series[l].data, n = 0; n < m.length; n++) g = m[n],
                e = null != g[0] ? g[0] : 0,
                f = null != g[1] ? g[1] : 0,
                j[n][0] += e,
                j[n][1] += f,
                ...
                for (var o = 0; o < k.length; o++) d.x.push(k[o][0]),
                d.y.push(k[o][1]);
                ...
                for (var o = 0; o < b.data.length; o++) d.x.push(b.data[o][0]),
                d.y.push(b.data[o][1]);
                this._stackData.push(b.data),
                this.series[c]._stackData = b.data,
                this._plotData.push(b.data),
            ...
            for (c > 0 && (b._prevPlotData = this.series[c - 1]._plotData), b._sumy = 0, b._sumx = 0, o = b.data.length - 1; o > -1; o--) b._sumy += b.data[o][1],
            b._sumx += b.data[o][0]
        },
        ...
        this.parseOptions = function (b) {
            ...
            this.defaults, b);
            var d = this.options;
            if (this.animate = d.animate, this.animateReplot = d.animateReplot, this.stackSeries = d.stackSeries, a.isPlainObject(d.fillBetween)) for (var f, g = ["series1", "series2", "color", "baseSeries", "fill"], c = 0, h = g.length; h > c; c++) f = g[c],
            ...
            for (var c = 0; 12 > c; c++) {
                var i = G[c],
                j = this.axes[i];
                j._options = a.extend(!0, {},
                d.axesDefaults, d.axes[i]),
            ...
            var k = function (b, c, d) {
                ...
                else for (e = 0, f = b.length; f > e; e++) g.push("vertical" == c ? [d + e, b[e]] : [b[e], d + e]);
                return g
            };
            this.series = [];
            for (var c = 0; c < this.data.length; c++) {
                ...
                g.show ? (g._xaxis.show = !0, g._yaxis.show = !0) : (g._xaxis.scaleToHiddenSeries && (g._xaxis.show = !0), g._yaxis.scaleToHiddenSeries && (g._yaxis.show = !0)),
        ...
        this.redraw = function (a) {
            ...
            a && (this.canvasManager.freeAllCanvases(), this.eventCanvas._elem.unbind(), this.target.empty());
            for (var b in this.axes) this.axes[b]._ticks = [];
            this.computePlotData(),
            this._sumy = 0,
            this._sumx = 0;
            for (var c = 0,
            d = this.series.length; d > c; c++) this._sumy += this.series[c]._sumy,
            this._sumx += this.series[c]._sumx;
            this.draw(),
        ...
        this.draw = function () {
            if (this.drawIfHidden || this.target.is(":visible")) {
                ...
                var t = this.series,
                u = t.length;
                for (b = 0, d = u; d > b; b++) c = this.seriesStack[b],
                ...
                this.legend.preDraw ? (this.eventCanvas._elem.before(e), this.legend.pack(r), this.legend._elem ? this.drawSeries({
                    legendInfo: {
                ...
                for (var b = 0,
                d = a.jqplot.eventListenerHooks.length; d > b; b++) this.eventCanvas._elem.bind(a.jqplot.eventListenerHooks[b][0], {
                    plot: this
                },
                a.jqplot.eventListenerHooks[b][1]);
                for (var b = 0,
                d = this.eventListenerHooks.hooks.length; d > b; b++) this.eventCanvas._elem.bind(this.eventListenerHooks.hooks[b][0], {
                    plot: this
                },
                ...
                for (var b = 0,
                d = a.jqplot.postDrawHooks.length; d > b; b++) a.jqplot.postDrawHooks[b].call(this);
                for (var b = 0,
                d = this.postDrawHooks.hooks.length; d > b; b++) this.postDrawHooks.hooks[b].apply(this, this.postDrawHooks.args[b]);
                this.target.is(":visible") && (this._drawCount += 1);
                var w, x, y, z;
                for (b = 0, d = u; d > b; b++) w = t[b],
                x = w.renderer,
                y = ".jqplot-point-label.jqplot-series-" + b,
                x.animation && x.animation._supported && x.animation.show && (this._drawCount < 2 || this.animateReplot) && (z = this.target.find(y), z.stop(!0, !0).hide(), w.canvas._elem.stop(!0, !0).hide(), w.shadowCanvas._elem.stop(!0, !0).hide(), w.canvas._elem.jqplotEffect("blind", {
                    mode: "show",
                    direction: x.animation.direction
                },
                x.animation.speed), w.shadowCanvas._elem.jqplotEffect("blind", {
                    mode: "show",
                    direction: x.animation.direction
                },
                x.animation.speed), z.fadeIn(.8 * x.animation.speed));
                z = null,
        ...
        this.drawSeries = function (b, c) {
            var d, e, f;
            if (c = "number" == typeof b && null == c ? b : c, b = "object" == typeof b ? b : {},
            c != F) e = this.series[c],
            ...
            else for (d = 0; d < this.series.length; d++) e = this.series[d],
            f = e.shadowCanvas._ctx,
            f.clearRect(0, 0, f.canvas.width, f.canvas.height),
            e.drawShadow(f, b, this),
            f = e.canvas._ctx,
        ...
        this.restorePreviousSeriesOrder = function () {
            ...
            if (this.seriesStack != this.previousSeriesStack) {
                for (a = 1; a < this.previousSeriesStack.length; a++) e = this.previousSeriesStack[a],
        ...
        this.restoreOriginalSeriesOrder = function () {
            ...
            if (this.seriesStack != d) for (this.previousSeriesStack = this.seriesStack.slice(0), this.seriesStack = d, a = 1; a < this.seriesStack.length; a++) b = this.series[a].canvas._elem.detach(),
    ...
    function j(a) {
        ...
        for (var l = [], m = [], n = 0, o = a.length; o > n; n++) l.push(a[n][1]),
        m.push(a[n][0]);
        for (var p, q, r, s, t = a.length - 1,
        u = 1,
        v = a.length; v > u; u++) {
            for (var w = [], x = [], y = 0; 2 > y; y++) {
                var n = u - 1 + y;
                w[y] = 0 == n || n == t ? Math.pow(10, 10) : l[n + 1] - l[n] == 0 || l[n] - l[n - 1] == 0 ? 0 : (m[n + 1] - m[n]) / (l[n + 1] - l[n]) + (m[n] - m[n - 1]) / (l[n] - l[n - 1]) == 0 ? 0 : (l[n + 1] - l[n]) * (l[n] - l[n - 1]) < 0 ? 0 : 2 / (b(m[n + 1], m[n]) / (l[n + 1] - l[n]) + b(m[n], m[n - 1]) / (l[n] - l[n - 1]))
            }
            ...
            for (var z, A, B = (m[u] - m[u - 1]) / g, y = 0, o = g; o > y; y++) z = [],
            A = m[u - 1] + y * B,
            z.push(A),
    ...
    function k(a) {
        ...
        for (var K = 0,
        L = a.length - 1; L > K; K++) for (null === w ? (E = Math.abs((a[K + 1][1] - a[K][1]) / (a[K + 1][0] - a[K][0])), q = .3, r = .6, s = (r - q) / 2, t = 2.5, u = -1.4, G = E / t + u, C = s * i(G) - s * i(u) + q, K > 0 && (F = Math.abs((a[K][1] - a[K - 1][1]) / (a[K][0] - a[K - 1][0]))), G = F / t + u, D = s * i(G) - s * i(u) + q, B = (C + D) / 2) : B = w, b = 0; A > b; b++) c = b / A,
        d = (1 + 2 * c) * Math.pow(1 - c, 2),
        e = c * Math.pow(1 - c, 2),
        f = Math.pow(c, 2) * (3 - 2 * c),
        g = Math.pow(c, 2) * (c - 1),
        a[K - 1] ? (j = B * (a[K + 1][0] - a[K - 1][0]), k = B * (a[K + 1][1] - a[K - 1][1])) : (j = B * (a[K + 1][0] - a[K][0]), k = B * (a[K + 1][1] - a[K][1])),
        a[K + 2] ? (l = B * (a[K + 2][0] - a[K][0]), m = B * (a[K + 2][1] - a[K][1])) : (l = B * (a[K + 1][0] - a[K][0]), m = B * (a[K + 1][1] - a[K][1])),
    ...
    function l() {
        for (var b = 0; b < this.series.length; b++) this.series[b].renderer.constructor == a.jqplot.LineRenderer && this.series[b].highlightMouseOver && (this.series[b].highlightMouseDown = !1)
    }
    function m() {
        this.plugins.lineRenderer && this.plugins.lineRenderer.highlightCanvas && (this.plugins.lineRenderer.highlightCanvas.resetCanvas(), this.plugins.lineRenderer.highlightCanvas = null),
    ...
    function n(a, b, c, d) {
        ...
        "line" === e.type && e.renderer.bands.show && (g.fill = !0, g.closePath = !0),
    ...
    function v(b, c, d) {
        for (var e, f, g, h, i, j, k, l = Math.floor(d / 2), m = Math.ceil(1.5 * d), n = Number.MAX_VALUE, o = c - b, p = a.jqplot.getSignificantFigures, q = 0, r = m - l + 1; r > q; q++) j = l + q,
        e = o / (j - 1),
        f = p(e),
        e = Math.abs(d - j) + f.digitsRight,
        n > e ? (n = e, g = j, k = f.digitsRight) : e === n && f.digitsRight < k && (g = j, k = f.digitsRight);
    ...
    function B(a, b) {
        if (null != b && "object" == typeof b) for (var c in b) "highlightColors" == c && (a[c] = A(b[c])),
        null != b[c] && "object" == typeof b[c] ? (a.hasOwnProperty(c) || (a[c] = {}), B(a[c], b[c])) : a[c] = b[c]
    }
    function C(a, b) {
    ...
    a.fn.emptyForce = function () {
        for (var b, c = 0; null != (b = a(this)[c]) ; c++) {
            ...
            else for (; b.firstChild;) b.removeChild(b.firstChild);
            b = null
        }
        return a(this)
    },
    a.fn.removeChildForce = function (a) {
        for (; a.firstChild;) this.removeChildForce(a.firstChild),
    ...
    a.fn.jqplot = function () {
        ...
        return this.each(function (d) {
            ...
            e = i.attr("id"),
            e === F && (e = "jqplot_target_" + a.jqplot.targetCounter++, i.attr("id", e)),
            f = a.jqplot(e, g, h),
            i.data("jqplot", f)
        })
    },
    a.jqplot = function (b, c, d) {
        var e = null,
        f = null;
        3 === arguments.length ? (e = c, f = d) : 2 === arguments.length && (a.isArray(c) ? e = c : a.isPlainObject(c) && (f = c)),
        null === e && null !== f && f.data && (e = f.data);
        var h = new g;
        if (a("#" + b).removeClass("jqplot-error"), !a.jqplot.config.catchErrors) return h.init(b, e, f),
        h.draw(),
    ...
    a.jqplot.CanvasManager = function () {
        ...
        this.getCanvas = function () {
            var c, d = !0;
            if (!a.jqplot.use_excanvas) for (var e = 0,
            f = a.jqplot.CanvasManager.canvases.length; f > e; e++) if (a.jqplot.CanvasManager.free[e] === !0) {
                d = !1,
            ...
            return d && (c = document.createElement("canvas"), b.push(a.jqplot.CanvasManager.canvases.length), a.jqplot.CanvasManager.canvases.push(c), a.jqplot.CanvasManager.free.push(!1)),
            c
        },
        ...
        this.freeAllCanvases = function () {
            for (var a = 0,
            c = b.length; c > a; a++) this.freeCanvas(b[a]);
            b = []
        },
        this.freeCanvas = function (b) {
            if (a.jqplot.use_excanvas && window.G_vmlCanvasManager.uninitElement !== F) window.G_vmlCanvasManager.uninitElement(a.jqplot.CanvasManager.canvases[b]),
    ...
    a.jqplot.support_canvas_text = function () {
        return "undefined" == typeof a.jqplot.support_canvas_text.result && (a.jqplot.support_canvas_text.result = window.G_vmlCanvasManager !== F && window.G_vmlCanvasManager._version > 887 ? !0 : !(!document.createElement("canvas").getContext || "function" != typeof document.createElement("canvas").getContext("2d").fillText)),
    ...
    b.prototype.resetDataBounds = function () {
        ...
        for (var c, d, e, f = this.show ? !0 : !1, g = 0; g < this._series.length; g++) if (d = this._series[g], d.show || this.scaleToHiddenSeries) {
            ...
            for (var j = 0,
            c = e.length; c > j; j++) "xaxis" == this.name || "x2axis" == this.name ? ((null != e[j][0] && e[j][0] < b.min || null == b.min) && (b.min = e[j][0]), (null != e[j][0] && e[j][0] > b.max || null == b.max) && (b.max = e[j][0])) : ((null != e[j][h] && e[j][h] < b.min || null == b.min) && (b.min = e[j][h]), (null != e[j][i] && e[j][i] > b.max || null == b.max) && (b.max = e[j][i]));
    ...
    e.prototype.init = function (b, c, d) {
        ...
        var e, f, g = this.data,
        h = [];
        for (e = 0, f = g.length; f > e; e++) if (this.breakOnNull) h.push(g[e]);
        else {
    ...
    e.prototype.toggleDisplay = function (a, b) {
        ...
        d ? c.canvas._elem.is(":hidden") || !c.show ? (c.show = !0, c.canvas._elem.removeClass("jqplot-series-hidden"), c.shadowCanvas._elem && c.shadowCanvas._elem.fadeIn(d), c.canvas._elem.fadeIn(d, b), c.canvas._elem.nextAll(".jqplot-point-label.jqplot-series-" + c.index).fadeIn(d)) : (c.show = !1, c.canvas._elem.addClass("jqplot-series-hidden"), c.shadowCanvas._elem && c.shadowCanvas._elem.fadeOut(d), c.canvas._elem.fadeOut(d, b), c.canvas._elem.nextAll(".jqplot-point-label.jqplot-series-" + c.index).fadeOut(d)) : c.canvas._elem.is(":hidden") || !c.show ? (c.show = !0, c.canvas._elem.removeClass("jqplot-series-hidden"), c.shadowCanvas._elem && c.shadowCanvas._elem.show(), c.canvas._elem.show(0, b), c.canvas._elem.nextAll(".jqplot-point-label.jqplot-series-" + c.index).show()) : (c.show = !1, c.canvas._elem.addClass("jqplot-series-hidden"), c.shadowCanvas._elem && c.shadowCanvas._elem.hide(), c.canvas._elem.hide(0, b), c.canvas._elem.nextAll(".jqplot-point-label.jqplot-series-" + c.index).hide())
    },
    ...
    a.jqplot.GenericCanvas.prototype.resetCanvas = function () {
        this._elem && (a.jqplot.use_excanvas && window.G_vmlCanvasManager.uninitElement !== F && window.G_vmlCanvasManager.uninitElement(this._elem.get(0)), this._elem.emptyForce()),
        this._ctx = null
    },
    ...
    a.jqplot.HooksManager.prototype.addOnce = function (a, b) {
        ...
        for (var c = !1,
        d = 0,
        e = this.hooks.length; e > d; d++) this.hooks[d] == a && (c = !0);
    ...
    a.jqplot.EventListenerManager.prototype.addOnce = function (a, b) {
        for (var c, d, e = !1,
        d = 0,
        f = this.hooks.length; f > d; d++) c = this.hooks[d],
        c[0] == a && c[1] == b && (e = !0);
    ...
    a.jqplot.computeHighlightColors = function (b) {
        ...
        if (a.isArray(b)) {
            ...
            for (var d = 0; d < b.length; d++) {
                for (var e = a.jqplot.getColorComponents(b[d]), f = [e[0], e[1], e[2]], g = f[0] + f[1] + f[2], h = 0; 3 > h; h++) f[h] = g > 660 ? .85 * f[h] : .73 * f[h] + 90,
                f[h] = parseInt(f[h], 10),
                f[h] > 255 ? 255 : f[h];
                f[3] = .3 + .35 * e[3],
            ...
            for (var e = a.jqplot.getColorComponents(b), f = [e[0], e[1], e[2]], g = f[0] + f[1] + f[2], h = 0; 3 > h; h++) f[h] = g > 660 ? .85 * f[h] : .73 * f[h] + 90,
            f[h] = parseInt(f[h], 10),
            f[h] > 255 ? 255 : f[h];
            f[3] = .3 + .35 * e[3],
    ...
    a.jqplot.rgb2hex = function (a) {
        for (var b = /rgba?\( *([0-9]{1,3}\.?[0-9]*%?) *, *([0-9]{1,3}\.?[0-9]*%?) *, *([0-9]{1,3}\.?[0-9]*%?) *(?:, *[0-9.]*)?\)/,
        c = a.match(b), d = "#", e = 1; 4 > e; e++) {
            var f; -1 != c[e].search(/%/) ? (f = parseInt(255 * c[e] / 100, 10).toString(16), 1 == f.length && (f = "0" + f)) : (f = parseInt(c[e], 10).toString(16), 1 == f.length && (f = "0" + f)),
            d += f
        }
        return d
    },
    ...
    a.jqplot.getColorComponents = function (b) {
        ...
        for (var c = a.jqplot.normalize2rgb(b), d = /rgba?\( *([0-9]{1,3}\.?[0-9]*%?) *, *([0-9]{1,3}\.?[0-9]*%?) *, *([0-9]{1,3}\.?[0-9]*%?) *,? *([0-9.]* *)?\)/, e = c.match(d), f = [], g = 1; 4 > g; g++) f[g - 1] = -1 != e[g].search(/%/) ? parseInt(255 * e[g] / 100, 10) : parseInt(e[g], 10);
    ...
    a.jqplot.AxisLabelRenderer.prototype.draw = function () {
        return this._elem && (this._elem.emptyForce(), this._elem = null),
    ...
    a.jqplot.CanvasGridRenderer.prototype.createElement = function (b) {
        var c;
        this._elem && (a.jqplot.use_excanvas && window.G_vmlCanvasManager.uninitElement !== F && (c = this._elem.get(0), window.G_vmlCanvasManager.uninitElement(c), c = null), this._elem.emptyForce(), this._elem = null),
    ...
    a.jqplot.CanvasGridRenderer.prototype.draw = function () {
        function b(b, d, e, f, g) {
            c.save(),
            g = g || {},
            (null == g.lineWidth || 0 != g.lineWidth) && (a.extend(!0, c, g), c.beginPath(), c.moveTo(b, d), c.lineTo(e, f), c.stroke(), c.restore())
        }
    ...
    a.jqplot.DivTitleRenderer.prototype.draw = function () {
        ...
        if (this._elem = a(b), this._elem.addClass("jqplot-title"), this.text) {
            if (this.text) {
                ...
                d.textAlign = "string" == typeof this.textAlign ? this.textAlign : "center",
                c && (d.color = c),
    ...
    a.jqplot.LineRenderer.prototype.init = function (b, c) {
        ...
        c.postInitHooks.addOnce(l), c.postDrawHooks.addOnce(m), c.eventListenerHooks.addOnce("jqplotMouseMove", p), c.eventListenerHooks.addOnce("jqplotMouseDown", q), c.eventListenerHooks.addOnce("jqplotMouseUp", r), c.eventListenerHooks.addOnce("jqplotClick", s), c.eventListenerHooks.addOnce("jqplotRightClick", t))
    },
    a.jqplot.LineRenderer.prototype.initBands = function (b) {
        var c = b.bandData || [],
        d = this.renderer.bands;
        d.hiData = [],
        d.lowData = [];
        var e = this.data;
        if (d._max = null, d._min = null, 2 == c.length) if (a.isArray(c[0][0])) {
            for (var f, g = 0,
            h = 0,
            i = 0,
            j = c[0].length; j > i; i++) f = c[0][i],
            (null != f[1] && f[1] > d._max || null == d._max) && (d._max = f[1]),
            (null != f[1] && f[1] < d._min || null == d._min) && (d._min = f[1]);
            for (var i = 0,
            j = c[1].length; j > i; i++) f = c[1][i],
            (null != f[1] && f[1] > d._max || null == d._max) && (d._max = f[1], h = 1),
            (null != f[1] && f[1] < d._min || null == d._min) && (d._min = f[1], g = 1);
            h === g && (d.show = !1),
            d.hiData = c[h],
            d.lowData = c[g]
        } else if (c[0].length === e.length && c[1].length === e.length) for (var k = c[0][0] > c[1][0] ? 0 : 1, l = k ? 0 : 1, i = 0, j = e.length; j > i; i++) d.hiData.push([e[i][0], c[k][i]]),
        d.lowData.push([e[i][0], c[l][i]]);
        else d.show = !1;
        else if (c.length > 2 && !a.isArray(c[0][0])) for (var k = c[0][0] > c[0][1] ? 0 : 1, l = k ? 0 : 1, i = 0, j = c.length; j > i; i++) d.hiData.push([e[i][0], c[i][k]]),
        d.lowData.push([e[i][0], c[i][l]]);
        else {
            var m = d.interval,
            n = null,
            o = null,
            p = null,
            q = null;
            if (a.isArray(m) ? (n = m[0], o = m[1]) : n = m, isNaN(n) ? "%" === n.charAt(n.length - 1) && (p = "multiply", n = parseFloat(n) / 100 + 1) : (n = parseFloat(n), p = "add"), null !== o && isNaN(o) ? "%" === o.charAt(o.length - 1) && (q = "multiply", o = parseFloat(o) / 100 + 1) : null !== o && (o = parseFloat(o), q = "add"), null !== n) {
                if (null === o && (o = -n, q = p, "multiply" === q && (o += 2)), o > n) {
                    var r = n;
                    n = o,
                    o = r,
                    r = p,
        ...
        t = d.lowData,
        i = 0,
        j = s.length; j > i; i++) (null != s[i][1] && s[i][1] > d._max || null == d._max) && (d._max = s[i][1]);
        for (var i = 0,
        j = t.length; j > i; i++) (null != t[i][1] && t[i][1] < d._min || null == d._min) && (d._min = t[i][1]);
        if (null === d.fillColor) {
            var u = a.jqplot.getColorComponents(d.color);
            u[3] = .5 * u[3],
            d.fillColor = "rgba(" + u[0] + ", " + u[1] + ", " + u[2] + ", " + u[3] + ")"
        }
    },
    a.jqplot.LineRenderer.prototype.setGridData = function () {
        var a = this._xaxis.series_u2p,
        b = this._yaxis.series_u2p,
        c = this._plotData,
        d = this._prevPlotData;
        this.gridData = [],
        this._prevGridData = [],
        this.renderer._smoothedData = [],
        this.renderer._smoothedPlotData = [],
        ...
        this.renderer._hiBandSmoothedData = [],
        this.renderer._lowBandSmoothedData = [];
        for (var e = this.renderer.bands,
        f = !1,
        g = 0,
        h = c.length; h > g; g++) null != c[g][0] && null != c[g][1] ? this.gridData.push([a.call(this._xaxis, c[g][0]), b.call(this._yaxis, c[g][1])]) : null == c[g][0] ? (f = !0, this.gridData.push([null, b.call(this._yaxis, c[g][1])])) : null == c[g][1] && (f = !0, this.gridData.push([a.call(this._xaxis, c[g][0]), null])),
        null != d[g] && null != d[g][0] && null != d[g][1] ? this._prevGridData.push([a.call(this._xaxis, d[g][0]), b.call(this._yaxis, d[g][1])]) : null != d[g] && null == d[g][0] ? this._prevGridData.push([null, b.call(this._yaxis, d[g][1])]) : null != d[g] && null != d[g][0] && null == d[g][1] && this._prevGridData.push([a.call(this._xaxis, d[g][0]), null]);
        if (f && (this.renderer.smooth = !1, "line" === this._type && (e.show = !1)), "line" === this._type && e.show) {
            for (var g = 0,
            h = e.hiData.length; h > g; g++) this.renderer._hiBandGridData.push([a.call(this._xaxis, e.hiData[g][0]), b.call(this._yaxis, e.hiData[g][1])]);
            for (var g = 0,
            h = e.lowData.length; h > g; g++) this.renderer._lowBandGridData.push([a.call(this._xaxis, e.lowData[g][0]), b.call(this._yaxis, e.lowData[g][1])])
        }
        if ("line" === this._type && this.renderer.smooth && this.gridData.length > 2) {
            var i;
            this.renderer.constrainSmoothing ? (i = j.call(this, this.gridData), this.renderer._smoothedData = i[0], this.renderer._smoothedPlotData = i[1], e.show && (i = j.call(this, this.renderer._hiBandGridData), this.renderer._hiBandSmoothedData = i[0], i = j.call(this, this.renderer._lowBandGridData), this.renderer._lowBandSmoothedData = i[0]), i = null) : (i = k.call(this, this.gridData), this.renderer._smoothedData = i[0], this.renderer._smoothedPlotData = i[1], e.show && (i = k.call(this, this.renderer._hiBandGridData), this.renderer._hiBandSmoothedData = i[0], i = k.call(this, this.renderer._lowBandGridData), this.renderer._lowBandSmoothedData = i[0]), i = null)
        }
    },
    a.jqplot.LineRenderer.prototype.makeGridData = function (a) {
        ...
        for (var e = this.renderer.bands,
        f = !1,
        g = 0; g < a.length; g++) null != a[g][0] && null != a[g][1] ? d.push([b.call(this._xaxis, a[g][0]), c.call(this._yaxis, a[g][1])]) : null == a[g][0] ? (f = !0, d.push([null, c.call(this._yaxis, a[g][1])])) : null == a[g][1] && (f = !0, d.push([b.call(this._xaxis, a[g][0]), null]));
        if (f && (this.renderer.smooth = !1, "line" === this._type && (e.show = !1)), "line" === this._type && e.show) {
            for (var g = 0,
            h = e.hiData.length; h > g; g++) this.renderer._hiBandGridData.push([b.call(this._xaxis, e.hiData[g][0]), c.call(this._yaxis, e.hiData[g][1])]);
            for (var g = 0,
            h = e.lowData.length; h > g; g++) this.renderer._lowBandGridData.push([b.call(this._xaxis, e.lowData[g][0]), c.call(this._yaxis, e.lowData[g][1])])
        }
        if ("line" === this._type && this.renderer.smooth && d.length > 2) {
            var i;
            this.renderer.constrainSmoothing ? (i = j.call(this, d), this.renderer._smoothedData = i[0], this.renderer._smoothedPlotData = i[1], e.show && (i = j.call(this, this.renderer._hiBandGridData), this.renderer._hiBandSmoothedData = i[0], i = j.call(this, this.renderer._lowBandGridData), this.renderer._lowBandSmoothedData = i[0]), i = null) : (i = k.call(this, d), this.renderer._smoothedData = i[0], this.renderer._smoothedPlotData = i[1], e.show && (i = k.call(this, this.renderer._hiBandGridData), this.renderer._hiBandSmoothedData = i[0], i = k.call(this, this.renderer._lowBandGridData), this.renderer._lowBandSmoothedData = i[0]), i = null)
        }
        return d
    },
    a.jqplot.LineRenderer.prototype.draw = function (b, c, d) {
        var e, f, g, h, i, j = a.extend(!0, {},
        d),
        k = j.shadow != F ? j.shadow : this.shadow,
        l = j.showLine != F ? j.showLine : this.showLine,
        m = j.fill != F ? j.fill : this.fill,
        n = j.fillAndStroke != F ? j.fillAndStroke : this.fillAndStroke;
        if (b.save(), c.length) {
            if (l) if (m) {
                if (this.fillToZero) {
                    var o = this.negativeColor;
                    this.useNegativeColors || (o = j.fillStyle);
                    var p = !1,
                    q = j.fillStyle;
                    if (n) var r = c.slice(0);
                    if (0 != this.index && this._stack) {
                        for (var s = this._prevGridData,
                        e = s.length; e > 0; e--) c.push(s[e - 1]);
                        k && this.renderer.shadowRenderer.draw(b, c, j),
                        this._areaPoints = c,
                        this.renderer.shapeRenderer.draw(b, c, j)
                    } else {
                        var t = [],
                        u = this.renderer.smooth ? this.renderer._smoothedPlotData : this._plotData;
                        this._areaPoints = []; {
                            var v = this._yaxis.series_u2p(this.fillToValue);
                            this._xaxis.series_u2p(this.fillToValue)
                        }
                        if (j.closePath = !0, "y" == this.fillAxis) {
                            t.push([c[0][0], v]),
                            this._areaPoints.push([c[0][0], v]);
                            for (var e = 0; e < c.length - 1; e++) if (t.push(c[e]), this._areaPoints.push(c[e]), u[e][1] * u[e + 1][1] <= 0) {
                                u[e][1] < 0 ? (p = !0, j.fillStyle = o) : (p = !1, j.fillStyle = q);
                                var w = c[e][0] + (c[e + 1][0] - c[e][0]) * (v - c[e][1]) / (c[e + 1][1] - c[e][1]);
                                t.push([w, v]),
                                this._areaPoints.push([w, v]),
                                k && this.renderer.shadowRenderer.draw(b, t, j),
                                this.renderer.shapeRenderer.draw(b, t, j),
                                t = [[w, v]]
                            }
                            u[c.length - 1][1] < 0 ? (p = !0, j.fillStyle = o) : (p = !1, j.fillStyle = q),
                            t.push(c[c.length - 1]),
                            this._areaPoints.push(c[c.length - 1]),
                            t.push([c[c.length - 1][0], v]),
                            this._areaPoints.push([c[c.length - 1][0], v])
                        }
                        k && this.renderer.shadowRenderer.draw(b, t, j),
                        this.renderer.shapeRenderer.draw(b, t, j)
                    }
                    ...
                    if (n) var r = c.slice(0);
                    if (0 != this.index && this._stack) for (var s = this._prevGridData,
                    e = s.length; e > 0; e--) c.push(s[e - 1]);
                    else {
                        var x = b.canvas.height;
                        c.unshift([c[0][0], x]);
                        var y = c.length;
                        c.push([c[y - 1][0], x])
                    }
                ...
                if (n) {
                    ...
                    if (this.renderer.shapeRenderer.draw(b, r, z), this.markerRenderer.show) for (this.renderer.smooth && (r = this.gridData), e = 0; e < r.length; e++) this.markerRenderer.draw(r[e][0], r[e][1], b, j.markerOptions)
                }
            } else {
                if (this.renderer.bands.show) {
                    var A, B = a.extend(!0, {},
                    j);
                    this.renderer.bands.showLines && (A = this.renderer.smooth ? this.renderer._hiBandSmoothedData : this.renderer._hiBandGridData, this.renderer.shapeRenderer.draw(b, A, j), A = this.renderer.smooth ? this.renderer._lowBandSmoothedData : this.renderer._lowBandGridData, this.renderer.shapeRenderer.draw(b, A, B)),
                    this.renderer.bands.fill && (A = this.renderer.smooth ? this.renderer._hiBandSmoothedData.concat(this.renderer._lowBandSmoothedData.reverse()) : this.renderer._hiBandGridData.concat(this.renderer._lowBandGridData.reverse()), this._areaPoints = A, B.closePath = !0, B.fill = !0, B.fillStyle = this.renderer.bands.fillColor, this.renderer.shapeRenderer.draw(b, A, B))
                }
                k && this.renderer.shadowRenderer.draw(b, c, j),
                this.renderer.shapeRenderer.draw(b, c, j)
            }
            var f = h = g = i = null;
            for (e = 0; e < this._areaPoints.length; e++) {
                var C = this._areaPoints[e]; (f > C[0] || null == f) && (f = C[0]),
                (i < C[1] || null == i) && (i = C[1]),
                (h < C[0] || null == h) && (h = C[0]),
                (g > C[1] || null == g) && (g = C[1])
            }
    ...
    a.jqplot.LineRenderer.prototype.drawShadow = function () { },
    ...
    a.jqplot.LinearAxisRenderer.prototype.draw = function (b, c) {
        if (this.show) {
            ...
            for (var e, f = this._ticks,
            g = 0; g < f.length; g++) e = f[g],
    ...
    a.jqplot.LinearAxisRenderer.prototype.set = function () {
        ...
        if (this.show) {
            for (var g, h = this._ticks,
            i = 0; i < h.length; i++) g = h[i],
            g._breakTick || !g.show || !g.showLabel || g.isMinorTick && !this.showMinorTicks || (b = "xaxis" == this.name || "x2axis" == this.name ? g._elem.outerHeight(!0) : g._elem.outerWidth(!0), b > c && (c = b));
            g = null,
            h = null,
            f && (d = this._label._elem.outerWidth(!0), e = this._label._elem.outerHeight(!0)),
            "xaxis" == this.name ? (c += e, this._elem.css({
                height: c + "px",
                left: "0px",
                bottom: "0px"
    ...
    a.jqplot.LinearAxisRenderer.prototype.createTicks = function (b) {
        ...
        if (this._scalefact = (Math.max(k, p + 1) - p) / 300, h.length) {
            ...
            if (null != this.tickOptions && this.tickOptions.formatString || (this._overrideFormatString = !0), null == this.min || null == this.max && null == this.tickInterval && !this.autoscale) {
                this.forceTickAt0 && (c > 0 && (c = 0), 0 > d && (d = 0)),
                this.forceTickAt100 && (c > 100 && (c = 100), 100 > d && (d = 100));
                var x = !1,
                y = !1;
                ...
                B = null != this.max ? d : d - w * (this.padMax - 1); (A > c || d > B) && (A = null != this.min ? c : c - w * (this.padMin - 1), B = null != this.max ? d : d + w * (this.padMax - 1), z = a.jqplot.LinearTickGenerator(A, B, this._scalefact, s, x, y)),
                this.min = z[0],
                this.max = z[1],
                ...
                if (this.autoscale && null == this.min && null == this.max) {
                    ...
                    if (G) this.numberTicks = 2 + Math.ceil((k - (this.tickSpacing - 1)) / this.tickSpacing),
                    this.min = 0,
                    l = 0,
                    ...
                    } else null == this.numberTicks && (this.numberTicks = this.tickInterval ? 3 + Math.ceil(w / this.tickInterval) : 2 + Math.ceil((k - (this.tickSpacing - 1)) / this.tickSpacing)),
                    null == this.tickInterval ? (E = w / (this.numberTicks - 1), v = 1 > E ? Math.pow(10, Math.abs(Math.floor(Math.log(E) / Math.LN10))) : 1, this.tickInterval = Math.ceil(E * v * this.pad) / v) : v = 1 / this.tickInterval,
                    ...
                    w = u - t,
                    null == this.numberTicks && (this.numberTicks = null != this.tickInterval ? Math.ceil((u - t) / this.tickInterval) + 1 : k > 100 ? parseInt(3 + (k - 100) / 75, 10) : 2),
                ...
                if (this.renderer.constructor == a.jqplot.LinearAxisRenderer && "" == this._autoFormatString) {
                    ...
                    if (U) {
                        ...
                        } else this.numberTicks = Math.ceil((m - l) / this.tickInterval) + 1,
            ...
            for (var r, Z, f = 0; f < this.numberTicks; f++) {
                if (e = this.min + f * this.tickInterval, r = new this.tickRenderer(this.tickOptions), r.setTick(e, this.name), this._ticks.push(r), f < this.numberTicks - 1) for (var N = 0; N < this.minorTicks; N++) e += this.tickInterval / (this.minorTicks + 1),
                Z = a.extend(!0, {},
                this.tickOptions, {
                    name: this.name,
                    value: e,
        ...
        this.tickInset && (this.min = this.min - this.tickInset * this.tickInterval, this.max = this.max + this.tickInset * this.tickInterval),
        g = null
    },
    a.jqplot.LinearAxisRenderer.prototype.resetTickValues = function (b) {
        if (a.isArray(b) && b.length == this._ticks.length) {
            for (var c, d = 0; d < b.length; d++) c = this._ticks[d],
            c.value = b[d],
    ...
    a.jqplot.MarkerRenderer.prototype.init = function (b) {
        ...
        -1 != this.style.indexOf("ircle") && (c.isarc = !0, c.closePath = !1),
        ...
        -1 != this.style.indexOf("ircle") && (d.isarc = !0, d.closePath = !1),
    ...
    a.jqplot.MarkerRenderer.prototype.drawPlus = function (b, c, d) {
        var e = 1,
        f = this.size / 2 * e,
        g = this.size / 2 * e,
        h = [[b, c - g], [b, c + g]],
        ...
        this.shadow && (this.shadowRenderer.draw(d, h, {
            closePath: !1
        }), this.shadowRenderer.draw(d, i, {
            closePath: !1
        })),
        this.shapeRenderer.draw(d, h, j),
        this.shapeRenderer.draw(d, i, j)
    },
    a.jqplot.MarkerRenderer.prototype.drawX = function (b, c, d) {
        ...
        i = [[b - f, c - g], [b + f, c + g]],
        j = [[b - f, c + g], [b + f, c - g]];
        this.shadow && (this.shadowRenderer.draw(d, i, {
            closePath: !1
        }), this.shadowRenderer.draw(d, j, {
            closePath: !1
        })),
        this.shapeRenderer.draw(d, i, h),
        this.shapeRenderer.draw(d, j, h)
    },
    a.jqplot.MarkerRenderer.prototype.drawDash = function (a, b, c, d, e) {
        var f = 1,
        g = this.size / 2 * f,
        h = (this.size / 2 * f, [[a - g, b], [a + g, b]]);
    ...
    a.jqplot.MarkerRenderer.prototype.draw = function (a, b, c, d) {
        if (d = d || {},
        null == d.show || 0 != d.show) switch (d.color && !d.fillStyle && (d.fillStyle = d.color), d.color && !d.strokeStyle && (d.strokeStyle = d.color), this.style) {
            case "diamond":
    ...
    a.jqplot.ShadowRenderer.prototype.draw = function (b, c, d) {
        ...
        for (var n = 0; k > n; n++) {
            ...
            else if (c && c.length) for (var p = !0,
            q = 0; q < c.length; q++) null != c[q][0] && null != c[q][1] ? p ? (o.moveTo(c[q][0], c[q][1]), p = !1) : o.lineTo(c[q][0], c[q][1]) : p = !0;
            h && o.closePath(),
            f ? b.fill() : b.stroke()
        }
        b.restore()
    ...
    a.jqplot.ShapeRenderer.prototype.draw = function (b, c, d) {
        ...
        if (b.lineWidth = e.lineWidth || this.lineWidth, b.lineJoin = e.lineJoin || this.lineJoin, b.lineCap = e.lineCap || this.lineCap, b.strokeStyle = e.strokeStyle || e.color || this.strokeStyle, b.fillStyle = e.fillStyle || this.fillStyle, b.beginPath(), k) return b.arc(c[0], c[1], c[2], c[3], c[4], !0),
        g && b.closePath(),
        f ? b.fill() : b.stroke(),
        void b.restore();
        if (j) return b.clearRect(c[0], c[1], c[2], c[3]),
        void b.restore();
        if (h || i) {
            if (h && b.fillRect(c[0], c[1], c[2], c[3]), i) return b.strokeRect(c[0], c[1], c[2], c[3]),
            void b.restore()
        } else if (c && c.length) {
            for (var n = !0,
            o = 0; o < c.length; o++) null != c[o][0] && null != c[o][1] ? n ? (m.moveTo(c[o][0], c[o][1]), n = !1) : m.lineTo(c[o][0], c[o][1]) : n = !0;
            g && m.closePath(),
            f ? b.fill() : b.stroke()
        }
        b.restore()
    ...
    a.jqplot.TableLegendRenderer.prototype.addrow = function (b, c, d, e) {
        ...
        this.showSwatches && (g = a(document.createElement("td")), g.addClass("jqplot-table-legend jqplot-table-legend-swatch"), g.css({
            textAlign: "center",
            paddingTop: k
        ...
        this.showLabels && (g = a(document.createElement("td")), g.addClass("jqplot-table-legend jqplot-table-legend-label"), g.css("paddingTop", k), f.append(g), this.escapeHtml ? g.text(b) : g.html(b)),
        g = null,
        i = null,
        j = null,
        f = null,
    ...
    a.jqplot.TableLegendRenderer.prototype.draw = function () {
        if (this._elem && (this._elem.emptyForce(), this._elem = null), this.show) {
            ...
            for (var e, f = !1,
            g = !1,
            h = 0; h < b.length; h++) if (e = b[h], (e._stack || e.renderer.constructor == a.jqplot.BezierCurveRenderer) && (g = !0), e.show && e.showLabel) {
    ...
    a.jqplot.ThemeEngine.prototype.init = function () {
        ...
        for (b in e.target) e.target[b] = this.target.css("textColor" == b ? "color" : b);
        if (this.title.show && this.title._elem) for (b in e.title) e.title[b] = this.title._elem.css("textColor" == b ? "color" : b);
        for (b in e.grid) e.grid[b] = this.grid[b];
        if (null == e.grid.backgroundColor && null != this.grid.background && (e.grid.backgroundColor = this.grid.background), this.legend.show && this.legend._elem) for (b in e.legend) e.legend[b] = this.legend._elem.css("textColor" == b ? "color" : b);
        var f;
        for (c = 0; c < this.series.length; c++) {
            f = this.series[c],
            e.series.push(f.renderer.constructor == a.jqplot.LineRenderer ? new L : f.renderer.constructor == a.jqplot.BarRenderer ? new N : f.renderer.constructor == a.jqplot.PieRenderer ? new O : f.renderer.constructor == a.jqplot.DonutRenderer ? new P : f.renderer.constructor == a.jqplot.FunnelRenderer ? new Q : f.renderer.constructor == a.jqplot.MeterGaugeRenderer ? new R : {});
        ...
        for (b in this.axes) {
            ...
            if (h._label && h._label.show) for (d in g.label) h._label[d] ? g.label[d] = h._label[d] : h._label._elem && (g.label[d] = h._label._elem.css("textColor" == d ? "color" : d))
        }
    ...
    a.jqplot.ThemeEngine.prototype.activate = function (b, c) {
        ...
        for (var i in b.axes) {
            ...
            if (j.show) {
                ...
                m = a.jqplot.extend(!0, {},
                k, l);
                if (f = null != e.axesStyles.borderColor ? e.axesStyles.borderColor : m.borderColor, null != m.borderColor && (j.borderColor = m.borderColor, d = !0), f = null != e.axesStyles.borderWidth ? e.axesStyles.borderWidth : m.borderWidth, null != m.borderWidth && (j.borderWidth = m.borderWidth, d = !0), j._ticks && j._ticks[0]) for (var n in m.ticks) f = m.ticks[n],
                null != f && (j.tickOptions[n] = f, j._ticks = [], d = !0);
                if (j._label && j._label.show) for (var n in m.label) f = m.label[n],
                null != f && (j.labelOptions[n] = f, d = !0)
            }
        }
    ...
    a.jqplot.extend = function () {
        ...
        e = arguments.length,
        f = !1;
        for ("boolean" == typeof c && (f = c, c = arguments[1] || {},
        d = 2), "object" != typeof c && "[object Function]" === !toString.call(c) && (c = {}) ; e > d; d++) if (null != (b = arguments[d])) for (var g in b) {
            var h = c[g],
            i = b[g];
    ...
    a.fn.jqplotToImageCanvas = function (b) {
        ...
        function d(b, d, e, f, g, h) {
            for (var i = c(b), j = a(b).innerWidth(), k = (a(b).innerHeight(), e.split(/\s+/)), l = k.length, m = "", n = [], o = g, p = f, q = 0; l > q; q++) m += k[q],
            d.measureText(m).width > j && (n.push(q), m = "", q--);
            if (0 === n.length) "center" === a(b).css("textAlign") && (p = f + (h - d.measureText(m).width) / 2 - s),
            d.fillText(e, p, g);
            else {
                ...
                o += i;
                for (var q = 1,
                r = n.length; r > q; q++) m = k.slice(n[q - 1], n[q]).join(" "),
                "center" === a(b).css("textAlign") && (p = f + (h - d.measureText(m).width) / 2 - s),
                d.fillText(m, p, o),
                o += i;
    ...
    var S = function () {
        switch (this.syntax = S.config.syntax, this._type = "jsDate", this.proxy = new Date, this.options = {},
        this.locale = S.regional.getLocale(), this.formatString = "", this.defaultCentury = S.config.defaultCentury, arguments.length) {
            case 0:
                break;
            case 1:
    ...
    S.prototype.getIsoWeek = function () {
        ...
        d = b + (c > 4 || 1 >= c ? 0 : 1);
        return 53 == d && new Date("" + a.getFullYear() + "/12/31").getDay() < 4 ? d = 1 : 0 === d && (a = new S(new Date("" + (a.getFullYear() - 1) + "/12/31")), d = a.getIsoWeek()),
        a = null,
        d
    },
    ...
    S.regional.getLocale = function () {
        ...
        return document && document.getElementsByTagName("html") && document.getElementsByTagName("html")[0].lang && (a = document.getElementsByTagName("html")[0].lang, S.regional.hasOwnProperty(a) || (a = S.config.defaultLocale)),
        a
    };
    var T = 864e5,
    U = function (a, b) {
    ...
    V = {
        ...
        month: {
            add: function (a, b) {
                ...
                12 == c ? (c = 0, a.setYear(a.getFullYear() + 1)) : -1 == c && (c = 11, a.setYear(a.getFullYear() - 1)),
                a.setMonth(c)
            },
            diff: function (a, b) {
    ...
    S.strftime = function (a, b, c, d) {
        ...
        ("[object Object]" != D(a) || "jsDate" != a._type) && (a = new S(a), a.locale = f),
        b || (b = a.formatString || S.regional[f].formatString);
        for (var g, h = b || "%Y-%m-%d",
        i = ""; h.length > 0;) (g = h.match(S.formats[e].codes.matcher)) ? (i += h.slice(0, g.index), i += (g[1] || "") + X(a, g[2], e), h = h.slice(g.index + g[0].length)) : (i += h, h = "");
        return i
    },
    S.formats = {
    ...
    S.createDate = function (a) {
        function b(a, b) {
            ...
            return g > 31 ? (d = i, e = h, c = j + g) : (d = h, e = g, c = j + i),
            f = e + "/" + d + "/" + c,
    ...
    S.matchers = [[/(3[01]|[0-2]\d)\s*\.\s*(1[0-2]|0\d)\s*\.\s*([1-9]\d{3})/, "$2/$1/$3"], [/([1-9]\d{3})\s*-\s*(1[0-2]|0\d)\s*-\s*(3[01]|[0-2]\d)/, "$2/$3/$1"],
    function (a) {
    ...
    a.jqplot.sprintf = function () {
        ...
        h = 0,
        i = g[h++];
        return i.replace(a.jqplot.sprintf.regex,
        function (i, j, k, l, m, n, o) {
            ...
            t = !1,
            u = !1,
            v = 0; k && v < k.length; v++) switch (k.charAt(v)) {
                case " ":
                    q = " ";
                    break;
                case "+":
    ...
    a.fn.extend({
        jqplotEffect: function () {
            function b(b) {
                function d() {
                    a.isFunction(g) && g.call(e[0]),
                    a.isFunction(b) && b()
                }
                var e = a(this),
                g = c.complete,
                h = c.mode; (e.is(":hidden") ? "hide" === h : "show" === h) ? d() : f.call(e[0], c, d)
            }
            var c = E.apply(this, arguments),
            d = c.mode,
            e = c.queue,
            f = a.jqplot.effects.effect[c.effect],
            g = !f && Y && a.jqplot.effects[c.effect];
            return a.fx.off || !f && !g ? d ? this[d](c.duration, c.complete) : this.each(function () {
                c.complete && c.complete.call(this)
            }) : f ? e === !1 ? this.each(b) : this.queue(e || "fx", b) : g.call(this, {
                options: c,
                duration: c.duration,
                callback: c.complete,
                mode: c.mode
