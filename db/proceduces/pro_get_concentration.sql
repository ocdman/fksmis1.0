...
-- Description:	<смяле╗╤х>
-- =============================================
CREATE PROCEDURE [dbo].[pro_get_concentration]
...
BEGIN
	...
	label1:begin
	    ...
	    set @sql = @sql + N' select CONVERT(real, AVG(YouYanND)) as YouYanND, convert(date,TimeUp,111) as TimeUp, 1 as FanRuntime,
							 @bit as IsDeleted, getdate() as AddDate, 0 as id, 
